...
//        boolean pen1C,pen2C,pen1D,pen2D;
   ...
   int[]ff;
    ...
    double a;
    String path;
     public GreyWolfOptimizer (int sets, int nbOfPlayersPerSet, int servers,double tick,int Dmax) {
...
//        
      ...
      catch (Exception e)
      {
        ...
        try {
            ...
            Logger.getLogger(GreyWolfOptimizer.class.getName()).log(Level.SEVERE, null, ex);
        }
